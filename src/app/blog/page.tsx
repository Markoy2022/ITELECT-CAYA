  ...
  return (
    <div className="container mx-auto px-8 py-16 max-w-6xl">
      <header className="mb-16 text-center space-y-4">
        ...
        <div className="w-24 h-1.5 bg-[#BFC873] mx-auto rounded-full"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {posts.map((post) => (
          <Card key={post.id} className="bg-white dark:bg-zinc-900 border-black/5 dark:border-white/5 overflow-hidden group hover:shadow-2xl transition-all duration-500 rounded-3xl">
            <div className="relative h-56 w-full overflow-hidden">
              ...
              <div className="absolute top-4 left-4">
                <span className="px-3 py-1 bg-[#BFC873] text-white text-[10px] font-bold tracking-widest rounded-full uppercase">
                  {post.category}
                </span>
              </div>
            </div>
            <CardHeader className="space-y-3 pt-6">
              ...
              <CardTitle className="text-xl font-bold leading-tight group-hover:text-[#BFC873] transition-colors">
                {post.title}
              </CardTitle>
            </CardHeader>
            <CardContent>
              ...
              <button className="text-xs font-bold tracking-widest text-black dark:text-white border-b-2 border-[#BFC873] pb-1 hover:border-black dark:hover:border-white transition-all">
                READ MORE
              </button>
            </CardContent>
          </Card>
